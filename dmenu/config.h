...
static const char *fonts[] = {
	"Iosevka Term:style=Medium:size=10:antialias=true:autohint=true",
	"JoyPixels:pixelsize=8:antialias=true:autohint=true"
};
static const char *prompt      = NULL;      /* -p  option; prompt to the left of input field */
static const char *colors[SchemeLast][2] = {
                	        /*   fg         bg    */
    [SchemeNorm] =          { "#ff79c6", "#222222" },
	[SchemeSel] =           { "#ffb86c", "#44475A" },
    [SchemeSelHighlight] =  { "#8be9fd", "#282a36" },
	[SchemeNormHighlight] = { "#ffb86c", "#282a36" },
    [SchemeOut] =           { "#000000", "#8be9fd" },
	[SchemeMid] =           { "#bd93f9", "#282a36" },
};
